...
class Form {
	...
	public function add($field, $name, $default='') {

		if (!isset($this->fields[$name])) {

			$field = 'Form_'.ucfirst($field);
			$field_object = new $field($name, $this,$default);
...
abstract class Form_Field {
	...
	public function __construct($name, $form, $default) {
		...
		if ($default != ''){
			$this->attrs['value'] = $default;
		}
		$onclick = "if(this.value==\"$default\")this.value=";
...
abstract class Form_Input extends Form_Field {
	...
	public function __construct($name, $form, $default) {
		...
		parent::__construct($name, $form, $default);
